...
<main class="form-signin w-100 m-auto">
    <form method="post" action="ServletPrincipal?accion=Login" id="FomrLogin">
        <img class="mb-4" src="assets/brand/bootstrap-logo.svg" alt="" width="72" height="57">
        <h1 class="h3 mb-3 fw-normal">Inicia sesion por favor</h1>

        <div class="form-floating">
            <input type="text" class="form-control" id="floatingInput" placeholder="Juan" name="usuario">

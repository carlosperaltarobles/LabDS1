...
public class ServletError extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        Integer codigoEstado=(Integer)request.getAttribute("javax.servlet.error.status_code");
        String nombreServlet=(String)request.getAttribute("javax.servlet.error.servlet_name");
        String peticionUrl=(String)request.getAttribute("javax.servlet.error.request_uri");
